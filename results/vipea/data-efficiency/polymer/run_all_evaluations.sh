...
for train_size in 0.8 0.2 0.05 0.02 0.01 0.005 0.002 0.001; do
  for i in {0..9}; do
    ...
    chemprop_train --data_path dataset-poly_chemprop.csv --split_sizes $train_size 0.1 $test_size --dataset_type regression --save_dir chemprop_checkpoints --aggregation $agg --gpu $gpu --pytorch_seed 0 --seed $i --metric rmse --extra_metrics r2 --polymer
